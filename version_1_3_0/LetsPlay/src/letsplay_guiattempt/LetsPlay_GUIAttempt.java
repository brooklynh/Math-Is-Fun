...
public class LetsPlay_GUIAttempt extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        questionNumber.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                questionNumberKeyPressed(evt);
            }
        });
        ...
        decimalPlaces.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                decimalPlacesKeyReleased(evt);
            }
        });
        ...
        questionsPlayerAnswer.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                questionsPlayerAnswerKeyPressed(evt);
            }
        });
        ...
        incorrectAnswerLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, incorrectAnswerLayout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(incorrectAnswerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(correctAnswerField, javax.swing.GroupLayout.PREFERRED_SIZE, 235, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(incorrectAnswerLayout.createSequentialGroup()
        ...
        incorrectAnswerLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, incorrectAnswerLayout.createSequentialGroup()
                ...
                .addGap(27, 27, 27)
                .addComponent(correctAnswerField, javax.swing.GroupLayout.PREFERRED_SIZE, 124, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(87, 87, 87)
        ...
        divisionPlayerAnswer.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                divisionPlayerAnswerKeyPressed(evt);
            }
        });
    ...
    private void questionNumberKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_questionNumberKeyPressed
        int key = evt.getKeyCode();
        if (key == java.awt.event.KeyEvent.VK_ENTER) {
            Boolean isValid = checkQuestionNumber(questionNumber.getText());
            if(!isValid){
                invalidQuestionNumber.setVisible(true);
            }else if((isValid && !(mode.equals("DIVISION"))) || (isValid && (precision != -1))){
                (new GameSetup()).execute();
            }
        }
    }//GEN-LAST:event_questionNumberKeyPressed

    private void decimalPlacesKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_decimalPlacesKeyReleased
        int key = evt.getKeyCode();
        if (key == java.awt.event.KeyEvent.VK_ENTER) {
            Boolean isValid = setPrecision(decimalPlaces.getText());
            if(!isValid){
                invalidPrecisionNumber.setVisible(true);
            }else if((isValid && (totalQuestions != -1)) && (mode.equals("DIVISION"))){
                (new GameSetup()).execute();
            }
        }
    }//GEN-LAST:event_decimalPlacesKeyReleased
    ...
    private void optionsButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_optionsButtonActionPerformed
        ...
        if(!isValid){
            invalidQuestionNumber.setVisible(true);
        }else if((isValid && !mode.equals("DIVISION")) || (isValid && precisionSet == true)){
            (new GameSetup()).execute();
        }
    }//GEN-LAST:event_optionsButtonActionPerformed

    private void questionsPlayerAnswerKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_questionsPlayerAnswerKeyPressed
        int key = evt.getKeyCode();
        if (key == java.awt.event.KeyEvent.VK_ENTER) {
    ...
    }//GEN-LAST:event_questionsPlayerAnswerKeyPressed
    ...
    private void divisionPlayerAnswerKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_divisionPlayerAnswerKeyPressed
        int key = evt.getKeyCode();
        if (key == java.awt.event.KeyEvent.VK_ENTER) {
    ...
    }//GEN-LAST:event_divisionPlayerAnswerKeyPressed
    ...
    class DisplayEquation extends SwingWorker<Void, Void>{
        ...
        protected Void doInBackground(){
            ...
            try{
                answer = computeAnswer.get();
            }catch(InterruptedException | ExecutionException e){
                Utilities.showErrorDialog("Unable to compute answer.", e);
            }
            return null;
        }
    }
    private class GetAnswer extends SwingWorker<BigDecimal, BigDecimal>{
        ...
        protected BigDecimal doInBackground(){
            BigDecimal answer = getAnswer(first, second);
            return answer;
        }
    }
    ...
    private class CheckAnswer extends SwingWorker<Void, Void>{
        ...
        protected Void doInBackground(){
            ...
            String message = getProgressPercent(currentQuestion);
    ...
    private void nextQuestion(){
        if(currentQuestion < totalQuestions){
            ...
            addScore(getScorePercent(score));
    ...
    private BigDecimal getScorePercent(int score){
        BigDecimal tempScore = getBigDecimal(score);
        BigDecimal tempQuestions = getBigDecimal(totalQuestions);
    ...
    private String getProgressPercent(int thisQuestion){
        String message;
        BigDecimal percentComplete;
        BigDecimal completed = getBigDecimal(thisQuestion);
        BigDecimal total = getBigDecimal(totalQuestions);
        BigDecimal tempPercent = completed.divide(total, mc);
        percentComplete = tempPercent.multiply(new BigDecimal(100));
        message = ""+(percentComplete.toPlainString())+"%";
        return message;
    }
    ...
    private MathContext mc = new MathContext(0);
